...
namespace HackerSpray.SampleDotNetCoreWebsite.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("HackerSpray.SampleDotNetCoreWebsite.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("HackerSpray.SampleDotNetCoreWebsite.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
